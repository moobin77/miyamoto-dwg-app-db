...
const target = `{drawing.attachedFiles && drawing.attachedFiles.length > 0 ? (
...
const replacement = `{drawing.attachedFiles && drawing.attachedFiles.length > 0 ? (
...
console.log("Patched DrawingViewer.tsx with GDrive support");
